...
class RegistrationWindow(AuthorizationWindow):
    def __init__(self, main_interface_class):
        super().__init__(main_interface_class, main_label_text="Регистрация")
    ...
    def create_interface(self):
        ...
        self.login_btn.move((self.width() - self.login_btn.width()) / 2, self.height() - 90)
